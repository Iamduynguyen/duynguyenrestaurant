...
export default function FixFoods() {
  ...
  useEffect(() => {
    const fetchFoodById = async () => {
      ...
      setFoodEditing({
        ...res,
        categoryId: res.category ? res.category.id : 7102,
      });
      setFoodDetail(res);
    ...
    <>
      {false && (
        <Container>
          ...
          <Dialog
            open={openDLAddDetail}
            onClose={() => setOpenDLAddDetail(false)}
          >
            <DialogTitle>
              {"Thêm chi tiết cho món ăn: " + select.name}
            </DialogTitle>
            <DialogContent>
              <DialogContentText>
                <Stack spacing={2}>
            ...
            <DialogActions>
              <Button onClick={() => setOpenDLAddDetail(false)}>
                Disagree
              </Button>
      ...
      <Row>
        ...
        <Col span={10} className="adm-edit--food">
          <div className="adm-edit--food__inner">
            ...
            <div className="adm-edit-food__img"></div>
            <Form
              form={form}
              labelCol={24}
              wrapperCol={24}
            ...
            >
              ...
              <Form.Item name="note" label="Ghi chú" initialValue={""}>
                <Input.TextArea />
              </Form.Item>
              <Form.Item>
                <AntdButton
      ...
      <Dialog open={openDLAddDetail} onClose={() => setOpenDLAddDetail(false)}>
        ...
        <DialogActions>
          ...
          <AntdButton
            className="my-btn"
            onClick={() => setOpenDLAddDetail(false)}
          >
            Hủy bỏ
          </AntdButton>
        </DialogActions>
...
const TabPanelCustom = ({ value, item, foodId, resetData }) => {
  ...
  const [discountPrg, setDiscountPrg] = useState(
    item.discount > 100 ? 100 : item.discount
  );
  ...
  return (
    <TabPanel value={value}>
      ...
      <Box>
        ...
        <AntdButton className="my-btn my-btn--primary" onClick={uploadImg2}>
          Up load hình ảnh
        </AntdButton>
      </Box>
      ...
      >
        ...
        <Form.Item label="Giảm giá">
          <div className="progress--action">
            <div
              className="progress--action__minus"
              onClick={() => {
            ...
            <div className="progress--action__input">{discountPrg} %</div>
            <div
              className="progress--action__plus"
              onClick={() => {
                let prg = discountPrg + 5;
